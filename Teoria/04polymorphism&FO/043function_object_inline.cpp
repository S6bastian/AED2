...
template <class T>
double measureTime(void (*func)(long[], long, long, T), long data[], long low, long high, T C) {
...
long partition(long array[], long low, long high, T C) {
...
template <class T>
void quickSort(long array[], long low, long high, T C) {
    if (C.cm(low, high)) {
