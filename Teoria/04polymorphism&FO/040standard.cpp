// Quick sort in C++
// Clear version without Polymorphism and Function Objects
...
double measureTime(void (*func)(long[], long, long), long data[], long low, long high) {
...
int main() {
    ...
    double elapsedTime = measureTime(quickSort, data, 0, n - 1);
